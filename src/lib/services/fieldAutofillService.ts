...
const FIELD_MAPPINGS: FieldMapping[] = [
  ...
  },
  {
    ...
    fieldLabel: "Nombre completo del director",
    entityType: "DIRECTOR",
    getValue: (d) => d.director.full_name || null,
  },
  {
    fieldKey: "director.passport_number",
    fieldLabel: "Número de pasaporte",
    entityType: "DIRECTOR",
  ...
  },
  {
    ...
    fieldLabel: "Nombre legal de la empresa",
    entityType: "COMPANY",
  ...
  },
  {
    ...
    fieldLabel: "NIF del representante",
    entityType: "REPRESENTATIVE",
